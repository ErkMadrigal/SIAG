<template>
  <div class="nom-view">
    ...
    <div class="view-header">
      ...
      <button v-if="resultado?.length" class="btn-primary-lg" @click="exportarXLSX">
...
.icon-btn {
  ...
  cursor:pointer; color:var(--acc); font-size:13px; transition:all .15s; margin:0 auto;
}
...
input[type="date"]:focus, select:focus { border-color:var(--acc); }
